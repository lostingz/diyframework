...
public class AdviceMatcher {
    ...
    private Logger logger = Logger.getLogger(AdviceMatcher.class.getName());
    ...
    public boolean match(Class<?> adviceAnnotationType, String joinPoint) {
        ...
        try {
            ...
            logger.info(joinPoint + ":" + e.getMessage());
            return false;
        }
        return true;
    }
    ...
    /**
     * 支持的方法名表达式有： 1)*xxx, 以*开头 2)xxx*, 以*结尾 3)* 所有 4)没有*,指定方法名 5)指定的annotation
     * 
     * @param pointcut
     * @param methodName
     * @return
